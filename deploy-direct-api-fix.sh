...
git commit -m "Update frontend to use direct API endpoint"
...
echo ""
echo "The frontend should now be able to communicate directly with the backend API."
