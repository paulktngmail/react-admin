...
// Get whitelisted users - Support both API paths for compatibility
app.get('/api/whitelist', getWhitelistedUsers);
app.get('/api/pool/whitelist', getWhitelistedUsers);

async function getWhitelistedUsers(req, res) {
  try {
    const params = {
...
// Add to whitelist - Support both API paths for compatibility
app.post('/api/whitelist/add', addToWhitelist);
app.post('/api/pool/whitelist/add', addToWhitelist);
...
// Bulk add to whitelist - Support both API paths for compatibility
app.post('/api/whitelist/bulk-add', bulkAddToWhitelist);
app.post('/api/pool/whitelist/bulk-add', bulkAddToWhitelist);

async function bulkAddToWhitelist(req, res) {
  try {
...
// Remove from whitelist - Support both API paths for compatibility
app.delete('/api/whitelist/remove', removeFromWhitelist);
app.delete('/api/pool/whitelist/remove', removeFromWhitelist);
